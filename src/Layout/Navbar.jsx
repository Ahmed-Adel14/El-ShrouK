                ...
                <div className="flex items-center h-full">
                    <div className="flex items-center w-[90%] h-full gap-2">
                        ...
                        <div className="flex items-center gap-6 flex-wrap h-full w-full font-medium cursor-pointer">
                            ...
                            <NavDropdown
                                title="أدوات مكتبية"
                                items={["أدوات تنظيم المكتب", "تجاليد وأغلفه كتب", "ألات حاسبه وأطقم هندسيه", "أوراق", "ممحاة", "شنط لاب توب", "دباسات", "ملفات ودفاتر"]}
                            />
                            <NavDropdown title="أدوات فنية" items={["الألوان", "أدوات الرسم", "أشغال يدوية", "كراسات رسم وتلوين"]} />
                            <NavDropdown title="ألعاب الأطفال" items={["ألعاب حركية",  "ألعاب رضع", "ألعاب تعليمية", "ألعاب متنوعة", "ألعاب ذكاء"]} />
